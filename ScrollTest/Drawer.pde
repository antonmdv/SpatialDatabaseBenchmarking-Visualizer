...
class Drawer {
  ...
  public void drawPoint(Point coord){
    ellipse(coord.x*SCALE_FACTOR+bx, coord.y*SCALE_FACTOR+by, 5, 5);
  }
  ...
  public void drawLineSegment(Point coord1, Point coord2){
    line(coord1.x*SCALE_FACTOR+bx, coord1.y*SCALE_FACTOR+by,
         coord2.x*SCALE_FACTOR+bx, coord2.y*SCALE_FACTOR+by);
  }
